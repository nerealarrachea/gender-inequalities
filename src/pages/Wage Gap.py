...
st.header("Gender wage gap predictor by industry")
...
st.text("Wage gap calculated from 2021 median weekly earnings of full-time salary workers in the United States as per the U.S. Bureau of Labor Statistics.")
